...
function App:makeResources() ---@return App.Resources
	...
	return {
		...
		---@format disable-next
		icons = {
			brush = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.brush.qoi")), "Brush icon not found")),
			eraser = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.david.eraser.qoi")), "Eraser icon not found")),
			pencil = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.pencil.qoi")), "Pencil icon not found")),
			bucket = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.bucket.qoi")), "Bucket icon not found")),
			text = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.text.qoi")), "Text icon not found")),
			palette = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.palette.qoi")), "Palette icon not found")),
			select = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.select.qoi")), "Select icon not found")),
			paste = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.paste.qoi")), "Paste icon not found")),
			magnifier = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.magnifier.qoi")), "Magnifier icon not found")),
			sound = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.sound.qoi")), "Sound icon not found")),
			soundMute = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.sound_mute.qoi")), "Sound mute icon not found")),
			vector = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.vector.qoi")), "Vector icon not found")),
			copy = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.copy.qoi")), "Copy icon not found")),
			cut = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.cut.qoi")), "Cut icon not found")),
			crop = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.crop.qoi")), "Crop icon not found")),
			resize = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.resize.qoi")), "Resize icon not found")),
			rotate = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.rotate.qoi")), "Rotate icon not found")),
			brushes = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.brushes.qoi")), "Brushes icon not found")),
			square = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.david.square.qoi")), "Square icon not found")),
			circle = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.david.circle.qoi")), "Circle icon not found")),
			line = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.david.line.qoi")), "Line icon not found")),
			curve = textureManager:upload(assert(Image.fromData(require("arisu.assets.icons.david.curve.qoi")), "Curve icon not found")),
		},
